...
namespace Hazel {
	...
	public:
		...
		static void DrawQuad(glm::mat4 transform, glm::vec4 color, float tilingFactor = 1.0f);
		static void DrawQuad(glm::mat4 transform, Ref<Texture2D> texture, float tilingFactor = 1.0f, glm::vec4 tintColor = glm::vec4(1.0f));
